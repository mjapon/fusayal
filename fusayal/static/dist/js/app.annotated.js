...
(function () {
    ...
    configIsyplus.$inject = ['$httpProvider'];
...
(function () {
    ...
    onIsyplusRun.$inject = ['$rootScope', 'ajaxAnimService', 'sideBarService'];
})();
(function () {
    'use strict';
    ...
    AutorizacionCntrl.$inject = ['$scope', '$state', 'AutorizacionServ', 'gridService', 'ModalServ'];
})();
(function () {
    'use strict';
    angular.module("isyplus")
    ...
    configAutList.$inject = ['$stateProvider'];
})();
(function () {
    'use strict';
    angular.module("isyplus")
    ...
    AutorizacionServ.$inject = ['$resource'];
})();
(function () {
    'use strict';
    angular.module("isyplus")
    ...
    AutorizacionFormCntrl.$inject = ['$scope', '$state', 'AutorizacionServ', 'NotifServ', 'focusService'];
})();
(function () {
    'use strict';
    angular.module("isyplus")
    ...
    configAutsForm.$inject = ['$stateProvider'];
...
(function () {
    ...
    configContribs.$inject = ['$stateProvider'];
...
(function () {
    ...
    ContribuyenteServ.$inject = ['$resource'];
...
(function () {
    ...
    configContribForm.$inject = ['$stateProvider'];
...
(function () {
    ...
    EmpresaCntrl.$inject = ['$scope', 'NotifServ', 'EmpresaServ', '$state'];
...
(function () {
    ...
    configLibroMayor.$inject = ['$stateProvider'];
})();
(function(){
    'use strict';
    angular.module("isyplus")
    ...
    HomeCntrl.$inject = ['$scope', '$state', 'AuthFactory', '$timeout'];
})();
...
(function () {
    ...
    function InitCntrl($scope, $state, LoginServ, NotifServ, AuthFactory) {
        ...
        function init(){
            console.log("InitCntrl--> check if user is logged");
            $state.go("home");
        }
...
(function () {
    ...
    JobFormCntrl.$inject = ['$scope', '$stateParams', '$state', 'JobService', 'AutorizacionServ', 'NotifServ', 'focusService', 'ListasServ'];
...
(function () {
    ...
    configJobForm.$inject = ['$stateProvider'];
...
(function () {
    ...
    LoginCntrl.$inject = ['$scope', '$state', 'LoginServ', 'NotifServ'];
})();
(function () {
    'use strict';
    angular.module("isyplus")
...
(function () {
    ...
    UserFormCntrl.$inject = ['$scope', '$state', '$stateParams', 'NotifServ', 'LoginServ', 'focusService', 'RolesServ'];
})();
(function () {
    'use strict';
    angular.module("isyplus")
    ...
    configForm.$inject = ['$stateProvider'];
...
(function () {
    ...
    UsuariosCntrl.$inject = ['$scope', '$state', '$transitions', 'LoginServ', 'NotifServ', 'gridService'];
...
(function (module) {
    ...
    BusArtDirectCntrl.$inject = ['$scope', '$timeout', 'BaseAutocompServ', 'GeneralSrv', 'ListasServ', 'tseccionRest', 'tclaveRest'];
})(IsyplusApp);
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    BusRetDirectCntrl.$inject = ['$scope', 'BaseAutocompServ'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function(module){
    ...
    ServiBuscaArtCntrl.$inject = ['$timeout', '$element'];
})(IsyplusApp);
/**
 * Created by serviestudios on 15/01/16.
 */
...
(function () {
    ...
    ServiConversionArtController.$inject = ['tartuniequiv', 'converArtService', 'swalService', '$scope', 'ModalServ'];
})();
/**
 * Created by serviestudios on 25/01/16.
 */
...
(function () {
    ...
    converArtService.$inject = ['$resource'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
(function () {
    ...
    CargaArchivoCntrl.$inject = ['$scope', 'CustomFileReader'];
...
(function () {
    ...
    PropiedadAdcDirCntrl.$inject = ['$scope', '$timeout'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    ModalCelebrantesDirCntrl.$inject = ['$scope', 'ModalServ', 'ModalCelebrantesService', 'AlertSrv', '$timeout'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    ModalCelebrantesService.$inject = ['$http'];
...
(function () {
    ...
    ModalDetallesArtCntrl.$inject = ['$scope', '$http', 'ModalServ'];
...
(function () {
    ...
    ModalProyectosDirCntrl.$inject = ['$scope', 'ModalServ', 'ModalProyectosService'];
...
(function () {
    ...
    ModalProyectosService.$inject = ['$http'];
...
(function (module) {
    ...
    ModalRetencionCntrl.$inject = ['$scope', '$http', '$timeout', 'ListasServ', 'NumberServ', 'focusService'];
})(IsyplusApp);
/**
 * Created by serviestudios on 20/04/16.
 */
...
(function () {
    ...
    ModalSeccionesDirCntrl.$inject = ['$scope', 'ModalServ', 'ModalSeccionesService'];
...
(function () {
    ...
    ModalSeccionesService.$inject = ['$http'];
...
(function () {
    ...
    ModalPagoCreditoCntrl.$inject = ['$scope', 'TBancoServ', 'CreditosTransaccServ', 'ListasServ', 'NumberServ', 'ReferenteSrv', 'GeneralSrv'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    ModalPagoDocumentoCntrl.$inject = ['$scope', 'TTipdocServ', 'TBancoServ', 'ReferenteSrv', 'GeneralSrv'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    ModalPagoGeneralCntrl.$inject = ['$scope'];
...
(function () {
    ...
    BuscarRefDirecCntrl.$inject = ['$scope', 'ReferenteSrv', 'GeneralSrv', 'AlertSrv', '$timeout'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function (module) {
    ...
    BuscarefCheckCntrl.$inject = ['$scope', 'BaseAutocompServ', 'GeneralSrv'];
...
(function () {
    ...
    AnioMesDirCntrl.$inject = ['$scope', 'FechasServ', 'NumberServ'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    rangoFechasAnioCntrl.$inject = ['$scope', 'FechasServ', 'NumberServ'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    RangoFechasAnioMesCntrl.$inject = ['$scope', 'FechasServ', 'NumberServ'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function (module) {
    ...
    BaseAutocompServ.$inject = ['$filter', '$http', '$timeout'];
...
(function (module) {
    ...
    GeneralSrv.$inject = ['$sessionStorageSrv', '$http', '$timeout', '$compile'];
})(IsyplusApp);
/**
...
(function (module) {
    ...
    AnimHttpInterceptor.$inject = ['$q', '$rootScope'];
})(IsyplusApp);
/**
 * Created by Manuel on 11/03/2015.
 */
...
(function (module) {
    ...
    NumberServ.$inject = ['$filter', '$locale'];
})(IsyplusApp);
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function (module) {
    ...
    ModalCmbNombreArtCntrl.$inject = ['$scope', 'ModalServ', 'ListasServ', 'NotifServ', 'focusService'];
...
(function (module) {
    ...
    ServiTrnResCntrl.$inject = ['$resource', '$scope'];
...
(function () {
    ...
    NgAutocompCntrl.$inject = ['$scope', '$element', '$attrs', '$filter', '$http', '$timeout'];
...
(function () {
    ...
    ngComplete.$inject = ['$filter', '$timeout', '$http'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    NgRangoFechasCntrl.$inject = ['$scope'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    NgSegridCntrl.$inject = ['$scope', '$filter', '$element'];
})();
/**
 * Created by serviestudios on 05/02/16.
 */
...
(function () {
    ...
    ngTable.$inject = ['$filter', '$anchorScroll', '$location'];
})();
/**
...
(function () {
    ...
    ngTablescrollv.$inject = ['$filter', '$anchorScroll', '$location'];
})();
/**
...
(function (module) {
    ...
    controller.$inject = ['FechasServ', '$scope'];
})(IsyplusApp);
/**
 * Created by serviestudios on 15/01/16.
 */
