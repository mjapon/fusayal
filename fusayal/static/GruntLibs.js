...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            javascript_vendor: {
                 src:[
                    '<%= rutas.path_bc %>/jquery/dist/jquery.min.js',
                    '<%= rutas.path_bc %>/angular/angular.min.js',
                    '<%= rutas.path_bc %>/angular-resource/angular-resource.min.js',
                    // '<%= rutas.path_bc %>/ui-router/release/angular-ui-router.min.js',
                     '<%= rutas.path_bc %>/angular-ui-router.min.js',
            ...
            css_vendor:{
                src:[
                    ...
                    '<%= rutas.path_bc %>/angular-ui-grid/ui-grid.min.css',
